...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], UserController.prototype, "createRequest", null);
__decorate([
    (0, common_1.Get)('admin/pending-requests'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], UserController.prototype, "getPendingRequests", null);
__decorate([
    (0, common_1.Patch)('admin/handle-request/:requestId'),
    __param(0, (0, common_1.Param)('requestId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "handleRequest", null);
__decorate([
    (0, common_1.Patch)('admin/toggle-ban/:id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "toggleBan", null);
__decorate([
