...
let AuthService = class AuthService {
    ...
    async login(felhasznalonev, jelszo) {
        ...
        if (!user) {
            throw new common_1.UnauthorizedException('Hibás felhasználónév vagy jelszó!');
        }
        if (user.isBanned) {
            throw new common_1.ForbiddenException('A fiókodat felfüggesztettük. Kérjük, fordulj az adminisztrátorhoz!');
        }
